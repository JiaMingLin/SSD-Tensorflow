...
from datasets import pascalvoc_to_tfrecords, dota_to_tfrecords, drone_detection_to_tfrecords, ucf101_24_detection_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'ucf101_24':
        ucf101_24_detection_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
