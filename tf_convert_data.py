...
from datasets import pascalvoc_to_tfrecords, dota_to_tfrecords, drone_action_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'drone':
        drone_action_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
